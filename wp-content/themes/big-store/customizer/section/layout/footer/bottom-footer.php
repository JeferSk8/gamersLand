...
$wp_customize->add_setting(
            'big_store_footer_bottom_col1_widget_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize,'big_store_footer_bottom_col1_widget_redirect', array(
                    'section'      => 'big-store-bottom-footer',
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_footer_bottom_col1_menu_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize,'big_store_footer_bottom_col1_menu_redirect', array(
                    'section'      => 'big-store-bottom-footer',
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_footer_bottom_col1_social_media_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize, 'big_store_footer_bottom_col1_social_media_redirect', array(
                    'section'      => 'big-store-bottom-footer',
...
// col2
/***************************************/
$wp_customize->add_setting('big_store_bottom_footer_col2_set',array(
        'default'        => 'none',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'esc_attr',
    ));
$wp_customize->add_control( 'big_store_bottom_footer_col2_set',array(
        'settings' => 'big_store_bottom_footer_col2_set',
        ...
        'text'             => __('Text','big-store'),
        'menu'             => __('Menu','big-store'),
        'search'           => __('Search','big-store'),
        'widget'           => __('Widget','big-store'),
        'social'           => __('Social Media','big-store'),     
        ),
    ));
// col2-text/html
$wp_customize->add_setting('big_store_bottom_footer_col2_texthtml', array(
        'default'           => __('Add your content here','big-store'),
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'big_store_sanitize_textarea', 
        'transport'         => 'postMessage',
    ));
$wp_customize->add_control('big_store_bottom_footer_col2_texthtml', array(
        'label'    => __('Text', 'big-store'),
        'section'  => 'big-store-bottom-footer',
        'settings' => 'big_store_bottom_footer_col2_texthtml',
         'type'    => 'textarea',
    ));
// col2 widget redirection
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_bottom_footer_col2_widget_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize,'big_store_bottom_footer_col2_widget_redirect', array(
                    'section'      => 'big-store-bottom-footer',
                    'button_text'  => esc_html__( 'Go To Widget', 'big-store' ),
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_bottom_footer_col2_menu_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize,'big_store_bottom_footer_col2_menu_redirect', array(
                    'section'      => 'big-store-bottom-footer',
                    'button_text'  => esc_html__( 'Go To Menu', 'big-store' ),
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_bottom_footer_col2_social_media_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize, 'big_store_bottom_footer_col2_social_media_redirect', array(
                    'section'      => 'big-store-bottom-footer',
                    'button_text'  => esc_html__( 'Go To Social Media', 'big-store' ),
...
// col3
$wp_customize->add_setting('big_store_bottom_footer_col3_set', array(
        'default'        => 'none',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'esc_attr',
    ));
$wp_customize->add_control('big_store_bottom_footer_col3_set', array(
        'settings' => 'big_store_bottom_footer_col3_set',
...
// col3-text/html
$wp_customize->add_setting('big_store_bottom_footer_col3_texthtml', array(
        'default'          => __('Add your content here','big-store'),
        'capability'       => 'edit_theme_options',
        'sanitize_callback'=> 'big_store_sanitize_textarea',  
        'transport'         => 'postMessage', 
    ));
$wp_customize->add_control('big_store_bottom_footer_col3_texthtml', array(
        'label'    => __('Text', 'big-store'),
        'section'  => 'big-store-bottom-footer',
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_bottom_footer_col3_social_media_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize, 'big_store_bottom_footer_col3_social_media_redirect', array(
                    'section'      => 'big-store-bottom-footer',
                    'button_text'  => esc_html__( 'Go To Social Media', 'big-store' ),
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_bottom_footer_col3_widget_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize,'big_store_bottom_footer_col3_widget_redirect', array(
                    'section'      => 'big-store-bottom-footer',
                    'button_text'  => esc_html__( 'Go To Widget', 'big-store' ),
...
if (class_exists('Big_Store_Widegt_Redirect')){ 
$wp_customize->add_setting(
            'big_store_bottom_footer_col3_menu_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Big_Store_Widegt_Redirect(
                $wp_customize,'big_store_bottom_footer_col3_menu_redirect', array(
                    'section'      => 'big-store-bottom-footer',
                    'button_text'  => esc_html__( 'Go To Menu', 'big-store' ),
...
$wp_customize->add_control(
            new Big_Store_WP_Customizer_Range_Value_Control(
                $wp_customize, 'big_store_btm_ftr_hgt', array(
...
if ( class_exists( 'Big_Store_WP_Customizer_Range_Value_Control' ) ){
$wp_customize->add_setting(
            'big_store_btm_ftr_botm_brd', array(
                'sanitize_callback' => 'big_store_sanitize_range_value',
                'default'           => '1',
                'transport'         => 'postMessage',
            )
...
$wp_customize->add_control(
            new Big_Store_WP_Customizer_Range_Value_Control(
                $wp_customize, 'big_store_btm_ftr_botm_brd', array(
                    'label'       => esc_html__( 'Top Border', 'big-store' ),
                    'section'     => 'big-store-bottom-footer',
                    'type'        => 'range-value',
                    'input_attr'  => array(
                        'min'  => 0,
...
// border-color
 $wp_customize->add_setting('big_store_bottom_frt_brdr_clr', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
...
$wp_customize->add_control( 
    new Big_Store_Customizer_Color_Control($wp_customize,'big_store_bottom_frt_brdr_clr', array(
        'label'      => __('Border Color', 'big-store' ),
        'section'    => 'big-store-bottom-footer',
        'settings'   => 'big_store_bottom_frt_brdr_clr',
    ) ) 
 );  
